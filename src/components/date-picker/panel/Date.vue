<template>
  <transition name="s-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="s-picker-panel s-date-picker s-popper"
      :class="[{
      ...
      <div class="s-picker-panel-body-wrapper">
        ...
        <div class="s-picker-panel-body">
          ...
          <div
            class="s-date-picker-header"
            :class="{ 's-date-picker-header-bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="s-picker-panel-icon-btn s-date-picker-prev-btn iconfont icon-double-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="s-picker-panel-icon-btn s-date-picker-prev-btn iconfont icon-left">
            </button>
            <span
            ...
            <button
              ...
              class="s-picker-panel-icon-btn s-date-picker-next-btn iconfont icon-double-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="s-picker-panel-icon-btn s-date-picker-next-btn iconfont icon-right">
            </button>
          </div>
...
<script>
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, SInput, 's-button': Button
    },
