              ...
              >
              {
                this._l(columns, (column, cellIndex) =>
                  <th
                    ...
                    {
                      column.filterable
                        ? <span class="s-table-column-filter-trigger" on-click={ ($event) => this.handleFilterClick($event, column) }><i class={ ['iconfont', column.filterOpened ? 'icon-top' : 'icon-bottom'] }></i></span>
                        : ''
                    }
                    </div>
                  </th>
